...
// //    // Filter down available choices dynamically based on user typing
...
// //             toast.error("Please select at least 1 core domain skill.");
// //             return;
// //          }
// //          if (watchedSkills.length > 5) {
// //             toast.error("You can choose a maximum of 5 core domain skills.");
// //             return;
// //          }
// //       }
// //       setStep((prev) => prev + 1);
...
// //    // Appends tags safely while protecting the max-5 ruleset cap
...
// //    // Removes explicitly clicked badges from the reactive array field
...
// //          toast.success("Interviewer profile complete! Welcome aboard.");
...
// //                   Step {step} of 3 — Interviewer Onboarding
// //                </span>
...
// //                {/* STEP 2: Autocomplete Tagbox Framework */}
// //                {step === 2 && (
// //                   <div className="space-y-6 animate-fadeIn">
// //                      <div className="space-y-2">
...
// //                         {/* Combined Interactive Tag Box Input Panel wrapper */}
...
// //                            {/* Hidden/Inline search controller */}
// //                            <input
// //                               type="text"
// //                               value={searchQuery}
...
// //                               className="flex-1 min-w-40 bg-transparent outline-none text-sm text-neutral-800 py-1 disabled:cursor-not-allowed"
// //                            />
// //                         </div>

// //                         {/* Dropdown Suggestions List panel overlay */}
// //                         {isDropdownOpen && filteredSuggestions.length > 0 && watchedSkills.length < 5 && (
// //                            <div className="absolute top-full left-0 w-full bg-white borde border-neutral-200 shadow-xl rounded-xl z-100 mt-1 max-h-56 overflow-y-auto divide-y divide-neutral-50">
...
// //                {/* STEP 3: Profile Verification + Allowed 5 Skills summary visualization */}
// //                {step === 3 && (
// //                   <div className="space-y-6 animate-fadeIn">
// //                      <div className="space-y-2">
// //                         <h2 className="text-lg font-bold text-neutral-800">Profile Configuration Display</h2>
// //                         <p className="text-sm text-neutral-500">Review your verification details and assigned validation tags below before submission.</p>
// //                      </div>
// //                      <div className="flex flex-col gap-2">
// //                         <label className="text-xs font-semibold text-neutral-600 uppercase">Profile Avatar Asset URL</label>
// //                         <input
// //                            type="url"
// //                            disabled={isLoading}
// //                            placeholder="https://cloudinary.com/assets/avatar..."
// //                            className={`w-full p-4 border rounded-xl outline-none focus:ring-2 focus:ring-indigo-500 transition ${
// //                               errors.profile_image_url ? "border-rose-500" : "border-neutral-300"
// //                            }`}
// //                            {...register("profile_image_url")}
// //                         />
// //                      </div>

// //                      {/* Profile Identity Blueprint Base Card */}
// //                      <div className="flex flex-col gap-4 p-5 rounded-xl border border-neutral-200 bg-neutral-50/50 shadow-inner">
// //                         <div className="flex items-center gap-4">
// //                            <img 
// //                               src={watch("profile_image_url") || "https://res.cloudinary.com/demo/image/upload/v1312461204/sample.jpg"} 
// //                               alt="Avatar preview" 
// //                               className="h-16 w-16 rounded-full object-cover border-2 border-neutral-200 shadow-sm"
// //                               onError={(e) => {
// //                                  (e.target as HTMLImageElement).src = "https://res.cloudinary.com/demo/image/upload/v1312461204/sample.jpg";
// //                               }}
// //                            />
// //                            <div>
// //                               <h4 className="text-base font-bold text-neutral-900">{watchedFirstName || "Interviewer Persona"}</h4>
// //                               <p className="text-sm text-neutral-500 font-medium">{watchedPosition || "Position"} @ {watchedCompany || "Company"}</p>
// //                            </div>
// //                         </div>

// //                         {/* NEW: Explicitly rendering the assigned Allowed Skills stack wrapper blocks inside Step 3 */}
// //                         <div className="pt-3 border-t border-neutral-200">
// //                            <span className="text-[11px] font-bold uppercase tracking-wider text-neutral-400 block mb-2">
// //                               Assigned Evaluation Specialties
// //                            </span>
// //                            <div className="flex flex-wrap gap-2">
// //                               {watchedSkills.map((skill: string) => (
// //                                  <span 
// //                                     key={skill} 
// //                                     className="bg-neutral-200 text-neutral-800 text-xs font-semibold px-3 py-1.5 rounded-lg border border-neutral-300 shadow-sm"
// //                                  >
// //                                     {skill}
// //                                  </span>
// //                               ))}
...
// //          <footer className="border-t z-10 border-neutral-200 bg-white px-8 py-5 flex items-center justify-between shadow-md">
// //             <div>
// //                {step > 1 ? (
// //                   <Button
// //                      outline
...
//    // Filter available choices dynamically based on user typing
//    const filteredSuggestions = AVAILABLE_SKILLS.filter(
//       (skill) =>
//          skill.toLowerCase().includes(searchQuery.toLowerCase()) &&
//          !watchedSkills.includes(skill)
...
//          <main className="flex-1 overflow-y-auto px-6 py-12 flex justify-center items-start">
...
//                {/* STEP 2: Company, Position & Skills Autocomplete */}
//                {step === 2 && (
//                   <div className="space-y-6 animate-fadeIn pb-64"> {/* Added padding to prevent layout constraint issues */}
//                      <div className="space-y-2">
//                         <h2 className="text-lg font-bold text-neutral-800">Professional Background</h2>
//                         <p className="text-sm text-neutral-500">Help candidates know your focus area. Type or select 1 to 5 target skill groups.</p>
//                      </div>
...
//                         {/* Combined Interactive Tag Box Input Panel */}
//                         <div className="w-full p-3 border border-neutral-300 bg-white rounded-xl flex flex-wrap gap-2 items-center focus-within:ring-2 focus-within:ring-indigo-500 focus-within:border-transparent transition">
//                            {watchedSkills.map((skill: string) => (
//                               <span 
//                                  key={skill} 
...
//                         {/* Dropdown Suggestions List panel overlay */}
//                         {isDropdownOpen && filteredSuggestions.length > 0 && watchedSkills.length < 5 && (
//                            /* ⚡ FIXED: Cased z-index directly to z-50 to ensure layout layer separation over footers */
...
//          {/* ⚡ FIXED: Dropped z-index stacking context on footer to z-0 so absolute drop downs flow on top */}
